    ...
    pub fn execute_instruction(
        ...
        match self {
            ...
            Authority::MultiSig { multisig, member } => {
                ...
                let multisig_account = rpc.get_account(multisig).map_err(|e| {
                    eyre::eyre!("Failed to fetch multisig account at {}: {}", multisig, e)
                })?;
                ...
                let (vault_pda, _) = squads::types::get_vault_pda(multisig, 0, &program_id); // vault_index = 0
